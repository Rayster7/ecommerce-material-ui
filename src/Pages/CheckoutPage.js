...
function CheckoutPage() {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData(prevData => {
      ...
      if (id === 'country') {
        setStates(country_and_states.state[value] || []);
        updatedData.state = ''; // Clear state if country changes
      }
      ...
      <Grid item xs={12} md={4}>
        <Card>
          <CardContent>
            ...
            <Divider sx={{ my: 2 }} />
            <Typography variant="body1">Produits: 50.00 €</Typography>
            <Typography variant="body1">Livraison: 5.00 €</Typography>
          ...
          <CardContent>
            ...
            <form noValidate onSubmit={handleSubmit}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth variant="outlined" required>
                    <InputLabel id="state-label">Région</InputLabel>
                    <Select
                      labelId="state-label"
                      id="state"
